...
{
    public class Ranked : MonoBehaviourPunCallbacks, IOnEventCallback
    {
        ...
        {
            _roomName.text = PhotonNetwork.CurrentRoom.Name.Split(";")[0];
        ...
        public override void OnPlayerLeftRoom(Player otherPlayer)
        {
            ...
            _players[PhotonNetwork.CurrentRoom.PlayerCount].SetReady(true);
